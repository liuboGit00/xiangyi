<template>
    <div class="leftaside" v-if="blankflag">
      ...
      <div class="leftpart">
        <el-menu  :default-active='activeIndexs' text-color="#ffffff" router  :collapse="isCollapse" @select="sends" :style="{padding:menucollapse}">
          ...
          <el-menu-item index="">
            ...
            <span class="oneleve" slot="title" >报告中心</span>
          </el-menu-item>
          <el-menu-item-group>
            <el-menu-item index="/Report-watch">
              <span slot="title">报告查看</span>
            </el-menu-item>
          </el-menu-item-group>
          <el-submenu index="1-1">
            <span slot="title" class="twoleve">报告编辑</span>
            <el-menu-item index="/Report-dashboardTemp">
              <span slot="title">大屏</span>
            </el-menu-item>
            <el-menu-item index="/Report-editChoiceTemp">
              <span slot="title">报告</span>
            </el-menu-item>              
          </el-submenu>
          <el-menu-item-group>
            <el-menu-item index="/Report-public">
                <span slot="title"  >报告发布</span>
            </el-menu-item>
          </el-menu-item-group>
          <el-menu-item-group>
            <el-menu-item index="/Report-receive">
