...
<script>
import LineChart from "@/common/ChartItem/LineChart.vue";
import PieChart from "@/common/ChartItem/PieChart.vue";
import BarChart from "@/common/ChartItem/BarChart.vue";
import TableChart from "@/common/ChartItem/TableChart.vue";
import {
  GetMethod,
  DeleteMethod,
  PutMethod,
