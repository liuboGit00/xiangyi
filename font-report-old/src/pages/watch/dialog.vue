  ...
  <div class="">
    <Dialogcomponent :dialogobj="dialogobj"  v-on:dialog-cancle="dialogHandle" v-on:dialog-sure="dialogHandlesure">
        <div v-if="dialogobj.title=='发布'">
          ...
          <el-form class="formpublic" ref="form" :model="form" label-width="">
              ...
              <el-form-item label="紧急程度">
                  <el-radio-group class="publicprogress" v-model="form.urgentType">
        ...
        <div v-if="dialogobj.title=='合并'">
          <el-form ref="ruleForm2" :model="form" :rules="rules2">
             <el-form-item label="请输入合并后的主题" prop="reportTitle">
                <el-input type="age" v-model="form.reportTitle" auto-complete="off" :maxlength='20'></el-input>
              </el-form-item>
              <el-form-item label="备注">
                  <el-input type="textarea" v-model="form.remark" :maxlength='200'></el-input>
              </el-form-item>
        ...
        <div v-if="dialogobj.title=='修改'">
          <el-form ref="ruleForm2" :model="form" :rules="rules2">
             <el-form-item label="修改标题"  prop="reportTitle">
                <el-input type="text" v-model="form.reportTitle" auto-complete="off"  :maxlength='20'></el-input>
                <!-- <span class="fonts">内容限制20字</span> -->
              </el-form-item>
              <el-form-item label="修改备注">
                  <el-input type="textarea" v-model="form.remark"  :maxlength='200'></el-input>
                  <!-- <span class="fonts">内容限制200字</span> -->
              </el-form-item>
          </el-form>
        </div>
...
export default {
  ...
  watch: {
    reportsmodel: function(newval, oldval) {
      this.form.reportTitle = newval.reportTitle;
  ...
  data() {
    ...
    return {
      ...
      reportsmodelprop: this.reportsmodel,
      form: {
        //保存的表单
        reportTitle: this.reportsmodel.reportTitle
          ? this.reportsmodel.reportTitle
          : "",
        remark: this.reportsmodel.remark ? this.reportsmodel.remark : "",
        usefulTime1: "",
        usefulTime2: "",
        urgentType: "3",
        allowTwice: "1"
      ...
      rules2: {
        ...
        reportTitle: [
          ...
          // { min: 1, max: 20, message: "内容限制20字", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    dialogHandlesure: function(message, type) {
      ...
      if (message == "发布") {
        this.resetChecked(); //左侧树形图选择的用户重置
        this.dataright = []; //右侧选择的用户重置
      }
    },
