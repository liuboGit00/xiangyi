...
window.localStorage.setItem("baseURL", baseUrl+"report-center/")
window.localStorage.setItem("imgBaseURL", baseUrl+"dm-project/upload/images/")
var $axios = axios.create({
    baseURL: baseUrl +"report-center/",
    headers: {
    }
});
